...
class App extends React.Component {
  render() {
    return (
      <>    
        <div className="cv-container bg-slate-50 grid text-lg md:bg-slate-300 md:pb-4 print:text-sm h-screen">
          <button className="hover:bg-blue-600 font-bold py-1 px-4 my-2 w-max rounded-md bg-blue-500 place-self-center transition-colors text-xl text-white print:hidden" onClick={()=>window.print()}>Print</button>   
